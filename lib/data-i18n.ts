...
const FAQ_NL: FaqSet = {
  traduction: [
    ...
    ["Wordt mijn vertaling door de administratie aanvaard?",
     "Voor elk document bestemd voor een officiële overheid — rechtbank, ambassade, consulaat of ministerie van Buitenlandse Zaken — is een beëdigde vertaling vereist. Onze vertalers zijn ingeschreven bij de Belgische rechtbanken en hun vertalingen worden erkend door de Belgische en internationale autoriteiten. Afhankelijk van het land van bestemming kan een legalisatie of apostille bijkomen: wij melden dit vanaf de offerte."],
  ...
  generale: [
    ...
    ["Hoe kan ik u bereiken?",
     "Per e-mail op info@travisum.com, of door langs te komen op kantoor. Voor een snelle offerte blijft het efficiëntst de scan van uw documenten per e-mail te sturen."],
...
const FAQ_EN: FaqSet = {
  traduction: [
    ...
    ["Will my translation be accepted by the administration?",
     "For any document intended for an official authority — court, embassy, consulate or Ministry of Foreign Affairs — a sworn translation is required. Our translators are registered with the Belgian courts and their translations are recognised by Belgian and international authorities. Depending on the destination country, a legalisation or apostille may be added: we flag it from the quote."],
  ...
  generale: [
    ...
    ["How can I reach you?",
     "By email at info@travisum.com, or by visiting the office. For a quick quote, the most efficient way remains sending the scan of your documents by email."],
