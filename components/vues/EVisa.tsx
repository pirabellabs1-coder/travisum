...
import { EVISA_REGIONS, EVISA_META, EVISA_ETAPES, EVISA_BUSINESS_MOTIFS } from "@/lib/evisa-contenu";
                  ...
                  {r.pays.map((p) => {
                    ...
                    return (
                      <a key={p.nom} className="ev-lcard" href={href}>
                        ...
                        <p className="ev-lc-teaser">{p.intro}</p>
                        <span className="ev-lc-go">{d.voir} →</span>
                      </a>
                    );
                  })}
                </div>
